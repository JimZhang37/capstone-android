...
import com.dong.edu.databinding.ActivityDetailDayBinding;
...
public class DetailDayActivity extends AppCompatActivity {
    private static final String TAG = DetailDayActivity.class.getSimpleName();
    ...
    private String mUID;
    private ActivityDetailDayBinding dataBinding;
    private Day mDay;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataBinding = DataBindingUtil.setContentView(this, R.layout.activity_detail_day);
        mDay = new Day();
